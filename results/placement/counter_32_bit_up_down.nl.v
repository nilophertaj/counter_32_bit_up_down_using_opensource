module counter_32_bit_up_down (INP_NEG_RST,
 ...
 sky130_fd_sc_hd__inv_2 _148_ (.A(net3),
    .Y(_000_));
 sky130_fd_sc_hd__nand2_1 _149_ (.A(net3),
    .B(net14),
    .Y(_121_));
 sky130_fd_sc_hd__or2_1 _150_ (.A(net3),
    .B(net14),
    .X(_122_));
 sky130_fd_sc_hd__clkbuf_2 _151_ (.A(net2),
    .X(_123_));
 sky130_fd_sc_hd__clkbuf_2 _152_ (.A(_123_),
    .X(_124_));
 sky130_fd_sc_hd__buf_2 _153_ (.A(_124_),
    .X(_125_));
 sky130_fd_sc_hd__a21oi_1 _154_ (.A1(_121_),
    .A2(_122_),
    .B1(_125_),
    .Y(_126_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _157_ (.A(_128_),
    .X(_011_));
 sky130_fd_sc_hd__xor2_1 _158_ (.A(net25),
    .B(_121_),
    .X(_129_));
 sky130_fd_sc_hd__xnor2_1 _159_ (.A(_126_),
    .B(_129_),
    .Y(_022_));
 sky130_fd_sc_hd__buf_2 _160_ (.A(_124_),
    .X(_130_));
 ...
 sky130_fd_sc_hd__inv_2 _163_ (.A(_132_),
    .Y(_133_));
 sky130_fd_sc_hd__or4_1 _164_ (.A(net28),
    .B(net25),
    .C(net3),
    .D(net14),
    .X(_134_));
 sky130_fd_sc_hd__dlymetal6s2s_1 _165_ (.A(_134_),
    .X(_135_));
 sky130_fd_sc_hd__o21ai_1 _166_ (.A1(net25),
    .A2(_122_),
    .B1(net28),
    .Y(_136_));
 ...
 sky130_fd_sc_hd__a31o_1 _168_ (.A1(_130_),
    ...
    .B1(_137_),
    .X(_025_));
 sky130_fd_sc_hd__buf_2 _169_ (.A(_123_),
    .X(_138_));
 ...
 sky130_fd_sc_hd__nand2_1 _181_ (.A(_132_),
    .B(_146_),
    .Y(_147_));
 sky130_fd_sc_hd__or4_1 _182_ (.A(net30),
    .B(net29),
    .C(net32),
    .D(net31),
    .X(_032_));
 ...
 sky130_fd_sc_hd__nand3_1 _199_ (.A(net4),
    ...
    .C(_042_),
    .Y(_045_));
 sky130_fd_sc_hd__o21ai_1 _200_ (.A1(net4),
    .A2(_043_),
    .B1(_045_),
    .Y(_046_));
 sky130_fd_sc_hd__xor2_1 _201_ (.A(net5),
    .B(_046_),
    .X(_002_));
 sky130_fd_sc_hd__or4_1 _202_ (.A(net34),
    .B(net33),
    .C(net5),
    .D(net4),
    .X(_047_));
 sky130_fd_sc_hd__or4_1 _203_ (.A(net2),
    ...
    .D(_047_),
    .X(_048_));
 sky130_fd_sc_hd__nand4_1 _204_ (.A(net5),
    .B(net4),
    .C(_123_),
    .D(_042_),
    .Y(_049_));
 ...
 sky130_fd_sc_hd__or4_1 _219_ (.A(net7),
    ...
    .D(net8),
    .X(_060_));
 sky130_fd_sc_hd__or4_2 _220_ (.A(_135_),
    .B(_032_),
    .C(_047_),
    .D(_060_),
    .X(_061_));
 ...
 sky130_fd_sc_hd__and4_1 _223_ (.A(_132_),
    ...
    .D(_063_),
    .X(_064_));
 sky130_fd_sc_hd__clkbuf_2 _224_ (.A(_064_),
    .X(_065_));
 ...
 sky130_fd_sc_hd__or2_1 _243_ (.A(_123_),
    .B(_078_),
    .X(_080_));
 sky130_fd_sc_hd__nand3_1 _244_ (.A(_123_),
    .B(_065_),
    .C(_074_),
    .Y(_081_));
 ...
 sky130_fd_sc_hd__or2_1 _258_ (.A(_077_),
    .B(_090_),
    .X(_091_));
 sky130_fd_sc_hd__or2_1 _259_ (.A(_061_),
    .B(_091_),
    .X(_092_));
 sky130_fd_sc_hd__and4_1 _260_ (.A(net16),
    ...
    .D(net17),
    .X(_093_));
 sky130_fd_sc_hd__and3_1 _261_ (.A(_065_),
    .B(_074_),
    .C(_093_),
    .X(_094_));
 ...
 sky130_fd_sc_hd__a21o_1 _274_ (.A1(net21),
    ...
    .B1(net22),
    .X(_104_));
 sky130_fd_sc_hd__and4_1 _275_ (.A(net20),
    .B(net19),
    .C(net22),
    .D(net21),
    .X(_105_));
 ...
 sky130_fd_sc_hd__or2_1 _277_ (.A(net22),
    .B(net21),
    .X(_107_));
 sky130_fd_sc_hd__or4_1 _278_ (.A(_061_),
    .B(_091_),
    .C(_101_),
    .D(_107_),
    .X(_108_));
 ...
 sky130_fd_sc_hd__a31o_1 _284_ (.A1(net23),
    ...
    .B1(net24),
    .X(_112_));
 sky130_fd_sc_hd__nand4_1 _285_ (.A(net24),
    .B(net23),
    .C(_094_),
    .D(_105_),
    .Y(_113_));
 sky130_fd_sc_hd__or3_1 _286_ (.A(net24),
    .B(net23),
    .C(_108_),
    .X(_114_));
 ...
 sky130_fd_sc_hd__a31o_1 _289_ (.A1(_130_),
    ...
    .B1(_116_),
    .X(_021_));
 sky130_fd_sc_hd__mux2_1 _290_ (.A0(_114_),
    .A1(_113_),
    .S(_138_),
    .X(_117_));
 ...
 sky130_fd_sc_hd__o22a_1 _294_ (.A1(_113_),
    ...
    .B2(_114_),
    .X(_120_));
 sky130_fd_sc_hd__xnor2_1 _295_ (.A(net27),
    .B(_120_),
    .Y(_024_));
 sky130_fd_sc_hd__dfrtp_4 _296_ (.CLK(clk),
    .D(_000_),
    .RESET_B(net35),
    .Q(net3));
 ...
 sky130_fd_sc_hd__dfrtp_2 _305_ (.CLK(clk),
    ...
    .RESET_B(net35),
    .Q(net34));
 sky130_fd_sc_hd__dfrtp_4 _306_ (.CLK(clk),
    .D(_001_),
    .RESET_B(net35),
    .Q(net4));
 ...
 sky130_fd_sc_hd__dfrtp_4 _312_ (.CLK(clk),
    ...
    .RESET_B(net37),
    .Q(net10));
 sky130_fd_sc_hd__dfrtp_4 _313_ (.CLK(clk),
    .D(_008_),
    .RESET_B(net36),
    .Q(net11));
 ...
 sky130_fd_sc_hd__buf_1 input1 (.A(INP_NEG_RST),
    .X(net1));
